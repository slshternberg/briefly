  ...
  return (
    <div className="grid gap-2.5">
      ...
      <button
        ...
        disabled={disabled}
        className="flex items-center gap-3 p-3 rounded-lg border border-border bg-background/40 hover:border-sky-400/40 hover:bg-sky-500/5 transition text-start disabled:opacity-50"
      >
        <div className="w-9 h-9 rounded-lg bg-sky-500/10 flex items-center justify-center shrink-0">
          <svg className="w-5 h-5 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M6 20.25h12M9.75 16.5h4.5M3.75 5.25A2.25 2.25 0 016 3h12a2.25 2.25 0 012.25 2.25v7.5A2.25 2.25 0 0118 15H6a2.25 2.25 0 01-2.25-2.25v-7.5z" />
          </svg>
        </div>
        <div className="flex-1 min-w-0">
